...
Updates the Delay FX filter to a high-pass filter.

[Download 16bit_1.6.0](https://github.com/bread-modular/bread-modular/releases/download/16bit_1.6.0/16bit_1.6.0.uf2)

### v1.5.0

Introduce a Techno Rumble FX for the Sampler App.

[Download 16bit_1.5.0](https://github.com/bread-modular/bread-modular/releases/download/16bit_1.5.0/16bit_1.5.0.uf2)
